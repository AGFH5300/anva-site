...
export default function NavLogoLottie() {
  ...
  return (
    <div className="nav-logo-lottie w-[148px] sm:w-[164px] lg:w-[176px]" aria-hidden="true">
      <div ref={containerRef} className="nav-logo-lottie__viewport h-9 w-full sm:h-10 lg:h-11" />
    </div>
  );
}
