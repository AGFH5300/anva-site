...
function Home() {
  ...
  return (
    <div data-node-id="aYtCzgLuEOHT" className="">
      ...
      >
        <div data-node-id="JiWOfPBWaCWm" className="">
          <div data-node-id="eJwWIABxuAxw" className="">
            <span data-node-id="jQYXkwrxjwtX" className="">
              <span data-node-id="BbsosjmLEBLC">ANVA</span>
            </span>
          </div>
          <div data-node-id="pipWZEBYfTCy" className="">
            <a data-node-id="CXdDrucOJkEv" href="#services">
              Services
            </a>
            <a data-node-id="eTnlTWSQuWSL" href="#brands">
              Brands
            </a>
            <a data-node-id="nTZRDbcQFzLD" href="#about">
              About
            </a>
            <a data-node-id="bZSXFJRMUxfp" href="/contact">
              Contact
            </a>
          </div>
        ...
        <div data-node-id="oTTDuwXjUfdw" className="" data-ref="mobile-menu">
          <div data-node-id="npQqhWgbIdgw" className="">
            <a data-node-id="SeBbHpOwptqN" href="#services">
              Services
            </a>
            <a data-node-id="ZaNRdhazVrFc" href="#brands">
              Brands
            </a>
            <a data-node-id="lMzPyPeHOFOr" href="#about">
              About
            </a>
            <a data-node-id="gyVctdlfbCCP" href="/contact">
              Contact
            </a>
          </div>
        </div>
        ...
        <div data-node-id="WMhUVXpUpceK" className="">
          <div data-node-id="eLmGrolwkACF" className="">
            ...
            <div data-node-id="EIvfpsqgfWaw" className="">
              ...
              <a data-node-id="NceAuDGndkoD" href="#services">
                View Services
              </a>
            </div>
          </div>
      ...
      <section data-node-id="zbUDJmXdYFKm" className="" id="about">
        <div data-node-id="pqJTWvCzThtX" className="">
          <div data-node-id="grzDnyaJCwjC" className="">
            <div data-node-id="RMxOnisFcIpf" className="">
              <h2 data-node-id="gNqJzggVtxPe">50 Years of Nautical Excellence</h2>
              <p data-node-id="FNyIBqUOGhPF">
              ...
              <div data-node-id="DPsCAykNYIAy" className="">
                <div data-node-id="VOHjJTvMClNw" className="">
                  <h3 data-node-id="xaHUKWvFfTwp">Quality &amp; Reliability</h3>
                  <p data-node-id="JlUZgDdHgeeS">
                    Uncompromising standards in every spare part and service hour.
                  </p>
                </div>
                <div data-node-id="CUqKPPddReRa" className="">
                  <h3 data-node-id="ZoPavSmtZvqf">Innovation</h3>
                  <p data-node-id="UpvOMyZLgdcJ">
                    Leveraging latest diagnostics and propulsion tech.
                  </p>
                </div>
                <div data-node-id="SDiBYgbWnWho" className="">
                  <h3 data-node-id="nUTirpRtqacm">Safety First</h3>
                  <p data-node-id="pkzuNgMGdxcz">
                    ISO 45001:2018 driven safety protocols.
                  </p>
                </div>
                <div data-node-id="ZDYuyCxSKVBj" className="">
                  <h3 data-node-id="rAEaNLAkQwIX">Sustainability</h3>
                  <p data-node-id="VHOZZnDpfVEc">
                    Eco-friendly cleaning and fuel-saving solutions.
                  </p>
                </div>
              </div>
            </div>
            <div data-node-id="fQrUCNEXLlsG" className="">
              <div data-node-id="HSYODDIWcecO" className=""></div>
              <img
                data-node-id="eTvtPyzSVhhG"
                src="https://images.unsplash.com/photo-1566835266472-351119b4b45d?q=80&amp;w=2070&amp;auto=format&amp;fit=crop"
              />
              <div data-node-id="YbTtuZOftTYw" className="">
                <div data-node-id="faHTfqmXSkRw" className="">
                  <svg
                  ...
                  <span data-node-id="yoPOPePdUCoV">Dubai Maritime City</span>
                </div>
                <p data-node-id="cobypArZKHqH">
      ...
      <section data-node-id="LsHYhUUxaorL" className="">
      ...
      <section data-node-id="gZIAADWmTQIH" className="">
        <div data-node-id="YKsPfVfFWADb" className="">
          <div data-node-id="ElFoPEYJljFy" className="">
            <svg
            ...
            <h3 data-node-id="HoIRNZEcFgco">eCommerce Store Coming Soon</h3>
            <p data-node-id="QekuPEBOkUPO">
              Direct purchase of Hydraulics, Filters, Valves, and Sensors. Search by
              part number with live stock integration.
            </p>
            <span data-node-id="YpCIxulaoyPW">Under Development</span>
          </div>
        </div>
      </section>
      <section data-node-id="NVgJDBqDOpYZ" className="" id="services">
        <div data-node-id="AXDLDSnezsiq" className="">
          <div data-node-id="BoiEMNyQZaaM" className="">
            <h2 data-node-id="eoqCRpbltwsN">Our Solutions</h2>
            <div data-node-id="iILcaUQOdBPB" className=""></div>
            <p data-node-id="ImNTEwbHCrve">
      ...
      <section data-node-id="KollGEIQYURt" className="">
        <div data-node-id="zwEKvhzzDcGO" className="">
          <div data-node-id="vERShxDcVqCK" className="">
            <div data-node-id="gzbkDjLLjARH" className="">
              <div data-node-id="XKBZxNYhOysQ" className="">
                <svg
                  data-node-id="iRDyCPuCNYag"
                  xmlns="http://www.w3.org/2000/svg"
                  width="24"
                  height="24"
                  viewBox="0 0 24 24"
                ...
                <span data-node-id="piadMyyOKywy">Engine Performance</span>
              </div>
              <h3 data-node-id="cngZgexoJjux">MARIDIS GmbH</h3>
              <p data-node-id="ktAYnyGcLPYR">
              ...
              <ul data-node-id="oZZsHLzQVrMs" className="">
                <li data-node-id="DEEYBiSLUjRL" className="">
                  <span data-node-id="NjFGXWyHQBxG" className=""></span>
                  <span data-node-id="gFDhmpNjHEuv">MarIDAn Online Diagnostics</span>
                </li>
                <li data-node-id="DbsCiGVSJfCs" className="">
                  <span data-node-id="CXCOobIZFKcO" className=""></span>
                  <span data-node-id="gEkcKRgrUvDL">PPA-01 Peak Pressure Gauges</span>
                </li>
                <li data-node-id="kAiAZXzSvvAD" className="">
                  <span data-node-id="jjWfefHGhcYT" className=""></span>
                  <span data-node-id="PQZyMGrFSvGm">
            ...
            <div data-node-id="FoOuCtkjfWyh" className="">
              <span data-node-id="DyGUaggKLErT">Authorized Rep</span>
              <svg
                data-node-id="yzNJorMYtuXU"
                xmlns="http://www.w3.org/2000/svg"
                width="24"
                height="24"
                viewBox="0 0 24 24"
      ...
      <section data-node-id="fRuGLjfAmRci" className="">
        <div data-node-id="waTaBYgyiFZl" className="">
          <div data-node-id="QdHUzZfpivYJ" className="">
            <div data-node-id="OcEUXYlAuOYn" className="">
              <svg
                data-node-id="zibLYLYyXqTm"
                xmlns="http://www.w3.org/2000/svg"
                width="24"
                height="24"
                viewBox="0 0 24 24"
            ...
            <div data-node-id="bsPRjhlGikSW" className="">
              <div data-node-id="TMRTMoLqnamR" className="">
                <svg
                  data-node-id="rRxtoYkgpMTW"
                  xmlns="http://www.w3.org/2000/svg"
                  width="24"
                  height="24"
                  viewBox="0 0 24 24"
                ...
                <span data-node-id="RYsOUgUizSqf">Hydraulic Power</span>
              </div>
              <h3 data-node-id="UeHoXrhdOkuY">Bosch Rexroth</h3>
              <p data-node-id="ZwLaWpVyWudP">
              ...
              <div data-node-id="JkyFOLRTOumZ" className="">
                <div data-node-id="eHtCMjetYCfa" className="">
                  <span data-node-id="eiyBTjninhAU">A10VSO / A4VSO</span>
                  <span data-node-id="YPcbNLDYzlOv">Axial Piston Pumps</span>
                </div>
                <div data-node-id="IymSFHoQXEAf" className="">
                  <span data-node-id="ZxZvKbFuYtgI">4WE6 / M4C</span>
      ...
      <section data-node-id="eQCxAGloxTHL" className="">
        <div data-node-id="UJRgLvYAAFfH" className="">
          <div data-node-id="DdBmIxNywqIv" className="">
            <div data-node-id="zWkrVYrfqGvV" className="">
              <div data-node-id="idqoQmJivMDt" className="">
                <svg
                  data-node-id="MmefMYgqXqfN"
                  xmlns="http://www.w3.org/2000/svg"
                  width="24"
                  height="24"
                  viewBox="0 0 24 24"
                ...
                <span data-node-id="ORhgbfAbvISA">Filtration Tech</span>
              </div>
              <h3 data-node-id="HJjxMXOCChfP">HYDAC Technology</h3>
              <p data-node-id="QIZXXIsfsXMF">
              ...
              <ul data-node-id="dNfZvJjvVwhO" className="">
                <li data-node-id="cYCFzHZxGidT" className="">
                  <span data-node-id="OwKbQhuSfIhW" className=""></span>
                  <span data-node-id="KlqsqEOBqKan">
                    0240D / 0330D Pressure Filters
                  </span>
                </li>
                <li data-node-id="HzGovTApxwOQ" className="">
                  <span data-node-id="birKvFRfRHXI" className=""></span>
                  <span data-node-id="zvIJlFFkzjQG">Aquamicron Elements</span>
                </li>
                <li data-node-id="IRngyHVkEPtR" className="">
                  <span data-node-id="LGlHwGBTJOnr" className=""></span>
                  <span data-node-id="rVqkZxRRxbgv">
            ...
            <div data-node-id="peDJtMHidTMm" className="">
              <svg
                data-node-id="SzbICwcBVkPI"
                xmlns="http://www.w3.org/2000/svg"
                width="24"
                height="24"
                viewBox="0 0 24 24"
      ...
      <section data-node-id="WOBXLTuXbxvS" className="">
        <div data-node-id="snilWkTmiFdT" className="">
          <div data-node-id="nnsdNfAzNJVk" className="">
            <div data-node-id="vrBsmlEJEArC" className="">
              <svg
                data-node-id="NrSRmwUqonaQ"
                xmlns="http://www.w3.org/2000/svg"
                width="24"
                height="24"
                viewBox="0 0 24 24"
            ...
            <div data-node-id="HAejaHvyWUZv" className="">
              <div data-node-id="nHNlDdntgjbc" className="">
                <svg
                  data-node-id="hXWtVeWjTJme"
                  xmlns="http://www.w3.org/2000/svg"
                  width="24"
                  height="24"
                  viewBox="0 0 24 24"
                ...
                <span data-node-id="wKYlMjCpKtbC">Marine Signaling</span>
              </div>
              <h3 data-node-id="HorViCVcADLh">Kockums Sonics</h3>
              <p data-node-id="fPbTodhdVpIH">
              ...
              <div data-node-id="hUdLgSEMJSYC" className="">
                <div data-node-id="kHaNcYUTAdHG" className="">
                  <span data-node-id="WWCSDrOPMJWH">Tyfon® Series</span>
                  <span data-node-id="xvLWSoCpyeXc">MKT 75/150 Whistles</span>
                </div>
                <div data-node-id="nCPTTSFOvLiK" className="">
                  <span data-node-id="ahMLTkNPObBc">TCP-2000</span>
      ...
      <section data-node-id="gUVBAlignLPM" className="">
        <div data-node-id="BXuwlDkUuEIm" className="">
          <div data-node-id="KVCcfmbCFIol" className="">
            <div data-node-id="HRGsNXZdIOZG" className="">
              <div data-node-id="uyyMzfqFgMPV" className="">
                <svg
                  data-node-id="EPtAHXqHkrUo"
                  xmlns="http://www.w3.org/2000/svg"
                  width="24"
                  height="24"
                  viewBox="0 0 24 24"
                ...
                <span data-node-id="XMuEttkLfJzi">Cargo Safety</span>
              </div>
              <h3 data-node-id="emTWscoZHZVD">Loadmaster &amp; Levelmaster</h3>
              <p data-node-id="KkkUoJbRHSrE">
              ...
              <ul data-node-id="oRapoBlDWnmu" className="">
                <li data-node-id="pMOrGnVfaXek" className="">
                  <span data-node-id="pXPvyWJZRdVH" className=""></span>
                  <span data-node-id="yxUdGhUpLikr">Loadmaster 2000 Software Support</span>
                </li>
                <li data-node-id="obWDAekhsqtx" className="">
                  <span data-node-id="ikKDUIooqZBz" className=""></span>
            ...
            <div data-node-id="aWPERYfSmsRL" className="">
              <svg
                data-node-id="VukVGELRGdSy"
                xmlns="http://www.w3.org/2000/svg"
                width="24"
                height="24"
                viewBox="0 0 24 24"
      ...
      <section data-node-id="elGztDEwTAhZ" className="">
        <div data-node-id="oMXrDIbHnCJe" className="">
          <div data-node-id="lIcLLHevNQve" className="">
            <div data-node-id="jhixbTWIFaDk" className="">
              <svg
                data-node-id="AcganpbOMIwN"
                xmlns="http://www.w3.org/2000/svg"
                width="24"
                height="24"
                viewBox="0 0 24 24"
            ...
            <div data-node-id="pwubrUZGbnyM" className="">
              <div data-node-id="FaVKoDQiFelF" className="">
                <svg
                  data-node-id="zAzmryemJfyE"
                  xmlns="http://www.w3.org/2000/svg"
                  width="24"
                  height="24"
                  viewBox="0 0 24 24"
                ...
                <span data-node-id="PvPSEBwjrfFW">Tank Cleaning</span>
              </div>
              <h3 data-node-id="TMmcapjrmVaN">Polarjet Marine</h3>
              <p data-node-id="xHYmYpvShHbh">
              ...
              <div data-node-id="FCrqnKKxGfCT" className="">
                <div data-node-id="isPnDPEoyulk" className="">
                  <span data-node-id="UZojGKtyxuWk">PJ15 / PJ30 / PJ60</span>
                  <span data-node-id="dUImxzQwMFnR">Rotary Jet Heads</span>
                </div>
                <div data-node-id="PtpgsmcuzkXT" className="">
                  <span data-node-id="aHohFbTAFieW">Portable CIP</span>
      ...
      <section data-node-id="NSVMzfnTHeFY" className="">
        <div data-node-id="FtQbmiyoSyjJ" className="">
          <div data-node-id="PbFLTkAQfnky" className="">
            <div data-node-id="zYDwoBGpnXEz" className="">
              <div data-node-id="iPYKDnRZLGtd" className="">
                <svg
                  data-node-id="tEbksnqSFSRY"
                  xmlns="http://www.w3.org/2000/svg"
                  width="24"
                  height="24"
                  viewBox="0 0 24 24"
                ...
                <span data-node-id="xwkfDPDFwLGc">Propulsion</span>
              </div>
              <h3 data-node-id="IwopeZQUsNoL">Subhadra Propellers</h3>
              <p data-node-id="tchgoPCmOzhZ">
              ...
              <ul data-node-id="ckfCWPyIHrSD" className="">
                <li data-node-id="eMwxMNXWiERw" className="">
                  <span data-node-id="uIIkylSgYUqC" className=""></span>
                  <span data-node-id="IvdEFhlfofdT">
                    SR-CP Controllable Pitch Propellers
                  </span>
                </li>
                <li data-node-id="aDUmZLtrbFzx" className="">
                  <span data-node-id="miAabSVgzdDn" className=""></span>
                  <span data-node-id="EcYCjfAsOSIz">
                    Nozzle Propellers (High Bollard Pull)
                  </span>
                </li>
                <li data-node-id="WaEATuJKnUxh" className="">
                  <span data-node-id="YkIjDwZYYnfN" className=""></span>
            ...
            <div data-node-id="OVyWACQVPoTT" className="">
              <svg
                data-node-id="gRahuzxnWvwn"
                xmlns="http://www.w3.org/2000/svg"
                width="24"
                height="24"
                viewBox="0 0 24 24"
      ...
      <section data-node-id="cFXAgJGnGPHD" className="">
        <div data-node-id="JTIElNVqvRcE" className="">
          <div data-node-id="wLgLNAoSeNTg" className="">
            <div data-node-id="lbrjedAZsmHI" className="">
              <svg
                data-node-id="IlliemGBGOlk"
                xmlns="http://www.w3.org/2000/svg"
                width="24"
                height="24"
                viewBox="0 0 24 24"
            ...
            <div data-node-id="uzjFneXFdvkP" className="">
              <div data-node-id="iEsJYyyRPXLP" className="">
                <svg
                  data-node-id="xckavdrgJYwo"
                  xmlns="http://www.w3.org/2000/svg"
                  width="24"
                  height="24"
                  viewBox="0 0 24 24"
                ...
                <span data-node-id="sSHsAdXhkJgZ">Corrosion Control</span>
              </div>
              <h3 data-node-id="XDSAKfauuore">ICCP &amp; MGPS Systems</h3>
              <p data-node-id="sDnweCQFLfwn">
              ...
              <div data-node-id="EHxnuAwDLkMD" className="">
                <div data-node-id="ZBdqjkxiLmNy" className="">
                  <span data-node-id="WDjWNpdSMKVD">ICCP</span>
                  <span data-node-id="AkfUOBClfHQP">Hull Corrosion Protection</span>
                </div>
                <div data-node-id="aahwNQLgWHTk" className="">
                  <span data-node-id="EOYUeRTKbMsZ">MGPS</span>
      ...
      <section data-node-id="wYMJtWDBbAgD" className="">
        <div data-node-id="cMNLrlEbxLXA" className="">
          <div data-node-id="lLDGCLkqDquU" className="">
            <svg
              data-node-id="LdvuuUgKmbnS"
              xmlns="http://www.w3.org/2000/svg"
              width="24"
              height="24"
              viewBox="0 0 24 24"
          ...
          <h2 data-node-id="lrVTwMjdVKSx">General Marine Spares</h2>
          <p data-node-id="rykXWkNtaoto">
          ...
          <div data-node-id="hJTrDRQehZZI" className="">
            <div data-node-id="FTKPAVDgfEqV">Main Engines</div>
            <div data-node-id="beRLegwXAcbt">Auxiliary Engines</div>
            <div data-node-id="zGOKAsFcCyGP">Purifiers</div>
            <div data-node-id="xNXVraaiKDAi">Compressors</div>
          </div>
        </div>
      </section>
      <footer data-node-id="EnSDwRneCzlm" className="" data-shared-component="site-footer">
        <div data-node-id="UyNbOrqBbqOA" className="">
            ...
            <div data-node-id="opBuatgafbMs" className="">
              ...
              <ul data-node-id="VgqbKCAGPaNg" className="">
                ...
                <li data-node-id="WXImVpmPKqJy" className="">
                  <a data-node-id="LkyvPLjLcSWF" href="#services">
                    Services &amp; Brands
                  </a>
                </li>
                <li data-node-id="UkZLnuzzCdBk" className="">
                  <a data-node-id="AZQumLiRYPtJ" href="#">
                    ISO &amp; Quality
                  </a>
                </li>
          ...
          <div data-node-id="TMLtgSJToVxy" className="">
            <p data-node-id="NYflBdruxRfp">
              © 2024 Advanced Nautical Ventures. All rights reserved.
            </p>
